...
class Timelog < ApplicationRecord
  ...
  scope :asc_start_time, -> { order("start_time asc") }
  scope :asc_end_time, -> { order("end_time asc") }
  scope :asc_duration, -> { order("duration asc") }
  scope :asc_trello_card, -> { order("trello_card asc") }
  scope :desc_start_time, -> { order("start_time desc") }
  scope :desc_end_time, -> { order("end_time desc") }
  scope :desc_duration, -> { order("duration desc") }
  scope :desc_trello_card, -> { order("trello_card desc") }
